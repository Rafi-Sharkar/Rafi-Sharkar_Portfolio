  ...
  return (
    <div className='font-[Poppins]'>
      ...
      <nav className='flex justify-between items-center w-[92%] mx-auto'>
        ...
        <div className={`md:static absolute text-center bg-white md:min-h-fit py-3 md:w-auto w-[100%] md:m-auto transition-all duration-500 top-[7.9%] items-center px-5 ${open ? 'left-[0%]': 'left-[-100%]'} z-40`}>
