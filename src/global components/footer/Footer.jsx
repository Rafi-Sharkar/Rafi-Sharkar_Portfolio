...
export default function Footer() {
  return (
    <div className='w-[100%] absolute bottom-0 bg-gradient-to-r from-[#00093c] to-[#2d0b00] text-white px-0 pt-[100px] pb-[0px] rounded-tl-[125px] text-[13px] leading-[20px] overflow-hidden'>
